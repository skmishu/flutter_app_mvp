...
//          new Image.network(data.img_src,height: 100,),
          ...
          Expanded(
            child: new Column(
              children: <Widget>[
                new Text(data.post_title, style: new TextStyle(fontWeight: FontWeight.bold),),
                new Text(data.p_id.toString(), style: new TextStyle(fontWeight: FontWeight.normal),),
                new Text(data.post_content, style: new TextStyle(fontWeight: FontWeight.normal),)
              ],
            ),
          ),
        ],
